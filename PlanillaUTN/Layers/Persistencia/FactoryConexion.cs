...
class FactoryConexion
{
    public static string CreateConnection()
    {
        ...
        {
            if (ConfigurationManager.ConnectionStrings[i].Name.Equals("PlanillaUTN.Properties.Settings.CadenaSqlServer", StringComparison.InvariantCultureIgnoreCase))
                existe = true;
        }
        ...
        return ConfigurationManager.ConnectionStrings["PlanillaUTN.Properties.Settings.CadenaSqlServer"].ConnectionString;
    }
    public static string CreateConnection(string pUsuario, String pContrasena)
    {
        ...
        conexion.AppendFormat("{0}", ConfigurationManager.ConnectionStrings["PlanillaUTN.Properties.Settings.CadenaSqlServer"].ConnectionString);
        // Agrega al usuario
