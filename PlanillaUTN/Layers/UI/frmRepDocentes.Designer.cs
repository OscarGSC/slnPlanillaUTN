namespace PlanillaUTN.Layers.UI
{
    partial class frmRepDocentes
    {
        ...
        private void InitializeComponent()
        {
            ...
            reportDataSource1.Name = "dsDocente";
            reportDataSource1.Value = this.DocenteBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "PlanillaUTN.Layers.UI.Reportes.RepoDocentes.rdlc";
            ...
            // 
            this.DocenteBindingSource.DataSource = typeof(PlanillaUTN.Layers.Entities.Docente);
            // 
            // frmRepDocentes
            // 
            ...
            this.Name = "frmRepDocentes";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Reporte de Docentes";
            this.Load += new System.EventHandler(this.frmRepDocentes_Load);
